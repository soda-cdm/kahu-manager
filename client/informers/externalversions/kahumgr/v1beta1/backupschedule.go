...
type BackupScheduleInformer interface {
	...
	Lister() v1beta1.BackupScheduleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KahumgrV1beta1().BackupSchedules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KahumgrV1beta1().BackupSchedules(namespace).Watch(context.TODO(), options)
			},
		},
		&kahumgrv1beta1.BackupSchedule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupScheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kahumgrv1beta1.BackupSchedule{}, f.defaultInformer)
}

func (f *backupScheduleInformer) Lister() v1beta1.BackupScheduleLister {
	return v1beta1.NewBackupScheduleLister(f.Informer().GetIndexer())
}
